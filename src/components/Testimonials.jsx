...
function Testimonials(){
  ...
  <div className="container px-5 py-24 mx-auto">
    <h1 className="text-5xl font-bold title-font text-gray-900 mb-12 text-center">
      Testimonials
    </h1>
        ...
        <div className="h-full bg-black p-8 rounded">
          ...
          <a className="inline-flex items-center">
            ...
            <span className="flex-grow flex flex-col pl-4">
              ...
              <span className="text-gray-300 text-sm">UI DEVELOPER</span>
            </span>
          </a>
        </div>
      </div>
        ...
        <div className="h-full bg-black p-8 rounded">
          ...
          <a className="inline-flex items-center">
            ...
            <span className="flex-grow flex flex-col pl-4">
              ...
              <span className="text-gray-300 text-sm">DESIGNER</span>
            </span>
          </a>
        </div>
      </div>
